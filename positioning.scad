...
module thumb_place (colIndex, rowIndex) {
  ...
  apply_key_context(colIndex, rowIndex)
  multmatrix(thumb_place_transformation(column, row))
    children();
}

module apply_key_context(colIndex, rowIndex) {
...
module finger_corner_nw(col, row) { multmatrix(finger_corner_transformation_nw(col, row)) children(); }
module finger_corner_ne(col, row) { multmatrix(finger_corner_transformation_ne(col, row)) children(); }
module finger_corner_se(col, row) { multmatrix(finger_corner_transformation_se(col, row)) children(); }
module finger_corner_sw(col, row) { multmatrix(finger_corner_transformation_sw(col, row)) children(); }
module finger_edge_n(col, row)    { multmatrix(finger_edge_transformation_n(col, row)) children(); }
module finger_edge_e(col, row)    { multmatrix(finger_edge_transformation_e(col, row)) children(); }
module finger_edge_s(col, row)    { multmatrix(finger_edge_transformation_s(col, row)) children(); }
module finger_edge_w(col, row)    { multmatrix(finger_edge_transformation_w(col, row)) children(); }

module thumb_corner_nw(col, row) { apply_key_context(col, row) multmatrix(thumb_corner_transformation_nw(col, row)) children(); }
module thumb_corner_ne(col, row) { apply_key_context(col, row) multmatrix(thumb_corner_transformation_ne(col, row)) children(); }
module thumb_corner_se(col, row) { apply_key_context(col, row) multmatrix(thumb_corner_transformation_se(col, row)) children(); }
module thumb_corner_sw(col, row) { apply_key_context(col, row) multmatrix(thumb_corner_transformation_sw(col, row)) children(); }
module thumb_edge_n(col, row)    { apply_key_context(col, row) multmatrix(thumb_edge_transformation_n(col, row)) children(); }
module thumb_edge_e(col, row)    { apply_key_context(col, row) multmatrix(thumb_edge_transformation_e(col, row)) children(); }
module thumb_edge_s(col, row)    { apply_key_context(col, row) multmatrix(thumb_edge_transformation_s(col, row)) children(); }
module thumb_edge_w(col, row)    { apply_key_context(col, row) multmatrix(thumb_edge_transformation_w(col, row)) children(); }
